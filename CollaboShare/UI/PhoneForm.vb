...
Namespace UI
    ...
    Public Class PhoneForm
        ...
        Private Function NewCreateUserView() As CreateUserView

        End Function

        Private Function NewJoinHouseholdView() As JoinHouseholdView

        End Function

        Private Function NewCreateHouseholdView() As CreateHouseholdView

        End Function

        Private Function NewHomeView() As CreateHouseholdView

        End Function

        Private Function NewChoresView() As ChoresView
